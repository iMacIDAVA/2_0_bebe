                    ...
                    TextButton(
                      ...
                      child: Text(l.veziTotiMediciiMediciOnline,
                          style: GoogleFonts.rubik(
                              color: const Color.fromRGBO(30, 214, 158, 1), fontSize: 12, fontWeight: FontWeight.w300)),
                    ),
                    TextButton(
                      onPressed: () {
                      ...
                      child: Text(l.veziTotiMediciiTotiMedicii,
                          style: GoogleFonts.rubik(
                              color: const Color.fromRGBO(30, 166, 219, 1), fontSize: 12, fontWeight: FontWeight.w300)),
                    ),
                  ],
                ),
              ),
